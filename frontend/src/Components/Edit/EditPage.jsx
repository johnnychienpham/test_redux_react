...
const EditPage = (props) => {
    ...
    const user= useSelector((state)=>state.user) // .user lay tu file store.js, dùng để lấy
    const dispatch= useDispatch(); // dùng để truyền
    ...
    const handleSubmit = (e)=>{
        ...
        // dispatch(update(updatedUser))// updatedUser là action parameter (state,action)
